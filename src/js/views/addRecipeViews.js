...
class AddRecipeView extends View {
  ...
  _generateMarkup() {
    ...
    <label>Title</label>
    <input value="supertest" required name="title" type="text" />
    <label>URL</label>
    <input value="supertest" required name="sourceUrl" type="text" />
    <label>Image URL</label>
    <input value="supertest" required name="image" type="text" />
    <label>Publisher</label>
    <input value="supertest" required name="publisher" type="text" />
